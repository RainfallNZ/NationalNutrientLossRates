...
for (WaterQualitySite in Catchments$sID[1:2] ){
  ...
  Types <- unique(CatchmentLandUseSlopeMoisture$Type)
  
  #Build a stack of single-Type rasters
  TypeStack <- lapply((1:length(Types)),function(x) {TypeGrid %in% x}) %>% rast()
